...
var _facility = require("./facility.js");
...
_socket2.default.connect(); // Brunch automatically concatenates all files in your
...
var channel = _socket2.default.channel("facility:" + window.facilityId, {});
channel.join();
$((0, _facility2.default)(channel));
});

;require.register("web/static/js/facility.js", function(exports, require, module) {
'use strict';
